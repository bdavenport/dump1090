...
function set_reset(test) {
    ...
    storevalue('2r','30');//slected planes red in rgb      
    storevalue('2g','30');//slected planes green in rgb
    storevalue('2b','30');//slected planes blue in rgb
    ...
    storevalue('setr','0');//truecolor red of rgb
    storevalue('setg','255');//truecolor green in rgb
    storevalue('setb','0');//truecolor blue in rgb
    storevalue('set2r','255');//falsecolor red in rgb      
    storevalue('set2g','0');//falsecolor green in rgb
    storevalue('set2b','0');//falsecolor blue in rgb
    storevalue('metric','false');
